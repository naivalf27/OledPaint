/*
  OledPaint -- Absil Dylan - Déprez Rémi - Mary Flavian

  ::
  
  You can use DEBUG_MDOE to see more stuff in the Serial
  There are two LEDs to indicate if the UDP & Wifi connections are successfuly done or not
  If you have anything to modify about the size or the U8G2 oLed, please modify the constants
  and the type of "u8g2" var.
*/
